...
// página sensible debe llamar a esto explícitamente. El rol y el estado
// activo se resuelven siempre contra la DB (nunca desde el cookie) para que
// desactivar/degradar una cuenta tenga efecto inmediato.
export async function requireAuth(rolMinimo?: Rol): Promise<Usuario> {
